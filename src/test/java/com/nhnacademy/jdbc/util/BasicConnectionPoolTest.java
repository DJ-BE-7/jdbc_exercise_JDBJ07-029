...
class BasicConnectionPoolTest {
    ...
    static void setUp() {
        ...
        basicConnectionPool = new BasicConnectionPool(com.mysql.cj.jdbc.Driver.class.getName(),"jdbc:mysql://133.186.241.167:3306/nhn_academy_129","nhn_academy_129","cK7xrbwr!",5);
    }
    ...
    void init(){
        Assertions.assertThrows(RuntimeException.class,
            ()-> new BasicConnectionPool("org.mariadb.jdbc.Driver","","","",5)
        );
    }
